...
| [`playos-shell`](https://github.com/PlayOS-Foundation/playos-shell) | Reference console UI built with Raylib. Controller-first, replaceable. | `src/main.cpp`, `CMakeLists.txt` |
