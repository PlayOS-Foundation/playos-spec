...
| Byte value | Event |
|---|---|
| `0x01` | `PLAYOS_LIFECYCLE_FOREGROUND` |
| `0x02` | `PLAYOS_LIFECYCLE_BACKGROUND` |
| `0x03` | `PLAYOS_LIFECYCLE_SUSPEND` |
| `0x04` | `PLAYOS_LIFECYCLE_RESUME` |
| `0x05` | `PLAYOS_LIFECYCLE_TERMINATE` |
