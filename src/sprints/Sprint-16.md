...
| S16-T8 | End-to-end validation (Ally + QEMU) | `playos-refdistro` | **done (Ally half)** | Scan (23 networks), connect, DHCP lease, live status verified; trust boundary verified (bridge/control/compositor sockets all refuse uid·gid 1001). QEMU half still outstanding |
